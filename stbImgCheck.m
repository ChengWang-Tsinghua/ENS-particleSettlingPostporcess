...
ifparticle = 0;
iftracer  = 1;
iffilter = 0; % if use median filter and gaussian filter, set to zero -> only susbtract bkg and separate treacer from intertial particle 
ifsave = 1;
...
%% 
    ...
    for k=Istart:img_num
        ...
        Im3 = imread(fname); 
        [Im3_sub,Im3t,Im3p]=preprocessing(Im3,thres_noise1,part_radius,thres_part3,1,bkg3,iffilter);
